// Pure utility functions for ETH Zurich semester boundary computation.
...
DateTime? currentSemesterStart(DateTime date) {
  final week = isoWeekNumber(date);
...
DateTime nextSemesterStart(DateTime date) {
  final week = isoWeekNumber(date);
  final year = date.year;
